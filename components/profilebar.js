    ...
    <div className="  relative hidden md:flex  bg-white z-50 items-center gap-5 border-[1px] border-[#E2E4E8] rounded-full    ">
      ...
      >
        <div className=" flex items-center gap-3 ">
          <div className=" h-[2.5rem] w-[2.5rem] rounded-full overflow-hidden bg-black ">
            {user.profilePic &&  <img src={user.profilePic} className=" h-full w-full rounded-full" alt="" srcset="" />}
