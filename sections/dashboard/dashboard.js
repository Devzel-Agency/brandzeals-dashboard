    ...
    return (
        <div className=' py-10 '>
            <Padding>
                ...
                <div>
                    <div className=' flex justify-between py-4 pt-10 text-[1.5rem] font-Satoshi font-medium  '>Recent Brands <div className=' font-Matter font-normal text-[0.9rem] '>View all</div> 
                    </div>
                    <div className=' bg-[#FFFFFF]  border-[#F1F1F1] border rounded-xl '>
                        ...
                        <div className=' bg-[#F9FAFB] grid grid-cols-6 px-5 py-3.5 '>
                            <div>1</div>
                            <div>Abdul Aziz</div>
                            <div className=' w-full truncate  lowercase'>Mohammedd@gmail.com</div>
                            <div>Abdul Aziz </div>
                            <div>7794966120</div>
                            <div>24/2/2024</div>
                        </div>
