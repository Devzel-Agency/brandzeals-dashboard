...
import Loginimg from "../../public/images/signup.png"
    ...
    return (
        <div className=' max-h-[100vh] min-h-[100vh] overflow-hidden  relative w-full '>
            ...
            <div className='flex absolute top-0  h-full w-full'>
                ...
                <Image className='h-full w-full lg:w-[30%] lg:hidden object-cover' src={Loginimg} />
            </div>
            <div className='max-h-[100svh] min-h-[100svh] flex justify-center items-center md:items-start md:pt-[8rem] lg:pt-0 lg:items-center'>
                <div className='w-[50%] h-[100vh]  hidden relative  lg:grid grid-rows-2 '>
                    <Image className='h-full w-full  absolute  hidden lg:block object-cover' src={Loginimg} />
                    ...
                    <div className=" w-full  pt-[1rem] xl:max-w-[500px] xl:min-w-[500px]     lg:border-[0px] h-max    rounded-3xl px-[1rem] md:px-[2rem]  ">
                        <div className=' flex flex-col leading-none  pb-8  lg:pb-8  gap-8'>
                            ...
                            <div className=' flex flex-col gap-4'>
                                ...
                                <div className='  font-Matter font-[700] text-[#FBFBFB] lg:text-[#8C8C8C]  tracking-[-4%] text-[1.3rem] text-center'>Hey, there</div>
                                <div className='  font-Matter font-[700] text-[#FBFBFB] lg:text-[#1D1F21]  tracking-[-4%] text-[1.5rem] text-center'>Let’s get you onboard</div>
                            </div>
                        ...
                        <div className=" text-[0.85rem]   font-Matter  flex flex-col gap-4 xl:gap-8 pb-6">
                            <div>
                                <div className=' text-white lg:text-[#1D1F21] font-medium  font-Matter pb-2 pl-1'>Email</div>
                                <input
                                    onClick={() => {
                                        setIsEmpty(0);
                                    }}
